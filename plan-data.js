...
// ============================================================
// 逐日具体计划（2026.9.10 – 9.30）：每天三条线各一件
// ds = 数据结构刷题（C++）｜py = Python 练手（够用即停）｜ts = TS 学+写
// 空字符串表示当天该线已停（Python 9.17 起停，时间给 TS / 刷题）。
// ============================================================

const DAILY_PLAN = [
  { date: "9.10", week: "四", ds: "二叉树前序遍历 · LC144（C++）", py: "字典：统计一句话每个词出现次数", ts: "装 Node + tsx，跑通第一个 hello.ts" },
  { date: "9.11", week: "五", ds: "二叉树中序遍历 · LC94", py: "字典进阶：写「姓名→分数」查分脚本（增删改查）", ts: "基本类型 + 写一个带类型的小函数" },
  { date: "9.12", week: "六", ds: "二叉树后序遍历 · LC145", py: "集合 set：列表去重、交集 / 差集", ts: "接口 interface：描述一个「学生 / 商品」对象并打印" },
  { date: "9.13", week: "日", ds: "层序遍历 · LC102（+ 手写三种遍历再一遍）", py: "函数：写判断素数 / 斐波那契", ts: "函数类型 + 可选/默认参数：写个计算器函数" },
  { date: "9.14", week: "一", ds: "前+中序构造二叉树 · LC105", py: "函数进阶：默认参数、返回多个值", ts: "类 class：写一个类并实例化" },
  { date: "9.15", week: "二", ds: "中+后序构造二叉树 · LC106", py: "文件读写：读一个 txt 统计词频 top5", ts: "泛型 generics：写 first<T> 和一个泛型函数" },
  { date: "9.16", week: "三", ds: "前+后序构造 · LC889（选做）+ 线索二叉树概念", py: "文件读写：把数据写进文件再读回来", ts: "联合类型 + 类型守卫：写类型收窄的例子" },
  { date: "9.17", week: "四", ds: "第10节 哈夫曼树（概念手写，无题）", py: "✅ Python 已够用，停（时间给 TS / 刷题）", ts: "async/await：写一个读文件的小脚本" },
  { date: "9.18", week: "五", ds: "N 叉树层序遍历 · LC429", py: "", ts: "async/await + fetch：调一个公开 JSON 接口打印" },
  { date: "9.19", week: "六", ds: "二叉树层平均值 · LC637", py: "", ts: "综合：写一个带类型的小命令行工具（内存版待办清单）" },
  { date: "9.20", week: "日", ds: "星型图中心节点 · LC1791", py: "", ts: "模块化：把之前的小脚本拆成多文件项目" },
  { date: "9.21", week: "一", ds: "小镇法官 · LC997", py: "", ts: "复习类型系统 + 查漏（把前 10 天小脚本重写一遍）" },
  { date: "9.22", week: "二", ds: "岛屿数量 · LC200", py: "", ts: "小工具：读文件 + 类型 + 输出统计结果" },
  { date: "9.23", week: "三", ds: "图像渲染 · LC733", py: "", ts: "fetch + 定义 API 返回类型的 interface" },
  { date: "9.24", week: "四", ds: "省份数量 · LC547", py: "", ts: "综合小项目：命令行待办清单（增删改查，存内存）" },
  { date: "9.25", week: "五", ds: "复习：栈/队列/递归（第5-8节）手写一遍", py: "", ts: "待办清单：加文件持久化（读写 JSON）" },
  { date: "9.26", week: "六", ds: "复习：树 + 图 DFS/BFS 手写", py: "", ts: "待办清单：拆模块 + 整理 README" },
  { date: "9.27", week: "日", ds: "机动：补本周没刷完的题", py: "", ts: "待办清单：补类型 + 错误处理" },
  { date: "9.28", week: "一", ds: "第13节 最小生成树 Prim/Kruskal（概念手写）", py: "", ts: "fetch 实战：写一个查天气 / 查 IP 的小工具" },
  { date: "9.29", week: "二", ds: "机动 / 复习：图相关题补漏", py: "", ts: "整理 9 月 TS 产出，写一份「我会什么」清单" },
