...
const DAILY_PLAN = {
  "2026-09": [
    { date: "9.13", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "（暂无旧题 · 先专注新题）" },
    ...
    { date: "9.20", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.13 学过的：LC144 · LC94" },
    ...
    { date: "9.21", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.14 学过的：LC94 · LC145" },
    ...
    { date: "9.22", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.15 学过的：LC145 · LC102" },
    ...
    { date: "9.23", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.16 学过的：LC102 · LC637" },
    ...
    { date: "9.28", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.18 学过的：LC106 · LC889" },
    ...
    { date: "9.29", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.22 学过的：LC429 · LC637" },
    ...
    { date: "9.30", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.23 学过的：LC637 · LC102" },
  ...
  "2026-10": [
    { date: "10.1", week: "四", rest: "休息：国庆假期 10.1–10.7 停摆，不排学习任务" },
    { date: "10.2", week: "五", rest: "休息：国庆假期 10.1–10.7 停摆，不排学习任务" },
    { date: "10.3", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "10.4", week: "日", rest: "休息：国庆假期 10.1–10.7 停摆，不排学习任务" },
    { date: "10.5", week: "一", rest: "休息：国庆假期 10.1–10.7 停摆，不排学习任务" },
    { date: "10.6", week: "二", rest: "休息：国庆假期 10.1–10.7 停摆，不排学习任务" },
    { date: "10.7", week: "三", rest: "休息：国庆假期 10.1–10.7 停摆，不排学习任务" },
    { date: "10.8", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.24 学过的：LC1791 · LC200" },
    ...
    { date: "10.9", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷假期前：LC733 · LC200" },
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.28 学过的：LC997 · LC733" },
    ...
    { date: "10.11", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷假期前：LC733 · LC200 + LC547 · LC994" },
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.29 学过的：LC200 · LC994" },
    ...
    { date: "10.12", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.8 学过的：LC110 · LC108" },
      { c: "main", label: "💙 TS", text: "命令行工具：解析 JSON + 打印" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "lc", label: "🧱 刷题", text: "K 站中转内最便宜的航班 · LC787 + 网络延迟时间 · LC743" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.28 学过的：LC733 · LC200" },
    ...
    { date: "10.13", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.9 学过的：LC108 · LC98" },
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 9.29 学过的：LC547 · LC994" },
    ...
    { date: "10.14", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.11 学过的：LC1 · LC49" },
    ...
    { date: "10.19", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.12 学过的：LC242 · LC128" },
    ...
    { date: "10.20", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.13 学过的：LC49 · LC1" },
    ...
    { date: "10.21", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.14 学过的：LC128 · LC242" },
    ...
    { date: "10.22", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.15 学过的：LC912 · LC75" },
    ...
    { date: "10.23", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.16 学过的：LC283 · LC912" },
    ...
    { date: "10.25", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.18 学过的：LC147 · LC148" },
    ...
    { date: "10.26", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.19 学过的：LC215 · LC703" },
    ...
    { date: "10.27", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.20 学过的：LC347 · LC215" },
    ...
    { date: "10.28", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.21 学过的：LC703 · LC347" },
    ...
    { date: "10.29", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.22 学过的：LC148 · LC147" },
    ...
    { date: "10.30", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.23 学过的：LC75 · LC912" },
  ...
  "2026-11": [
    { date: "11.1", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.25 学过的：LC33 · LC153" },
    ...
    { date: "11.2", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.26 学过的：LC34 · LC704" },
    ...
    { date: "11.3", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 10.27 学过的：LC4 · LC34" },
    ...
    { date: "11.8", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.1 学过的：LC1 · LC242" },
    ...
    { date: "11.9", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.2 学过的：LC206 · LC21" },
    ...
    { date: "11.10", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.3 学过的：LC141 · LC19" },
    ...
    { date: "11.11", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.4 学过的：LC20 · LC155" },
    ...
    { date: "11.12", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.5 学过的：LC232 · LC225" },
    ...
    { date: "11.13", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.6 学过的：LC739 · LC42" },
    ...
    { date: "11.15", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.8 学过的：LC102 · LC94" },
    ...
    { date: "11.16", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.9 学过的：LC98 · LC236" },
    ...
    { date: "11.17", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.10 学过的：LC3 · LC15" },
    ...
    { date: "11.18", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.11 学过的：LC76 · LC239" },
    ...
    { date: "11.19", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.12 学过的：LC438 · LC76" },
    ...
    { date: "11.20", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.13 学过的：LC239 · LC438" },
    ...
    { date: "11.22", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.15 学过的：LC15 · LC11" },
    ...
    { date: "11.23", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.16 学过的：LC42 · LC11" },
    ...
    { date: "11.24", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.17 学过的：LC70 · LC53" },
    ...
    { date: "11.25", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.18 学过的：LC300 · LC1143" },
    ...
    { date: "11.26", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.19 学过的：LC322 · LC198" },
    ...
    { date: "11.27", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.20 学过的：LC1143 · LC72" },
    ...
    { date: "11.29", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.22 学过的：LC198 · LC53" },
    ...
    { date: "11.30", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.23 学过的：LC62 · LC198" },
  ...
  "2026-12": [
    { date: "12.1", week: "二", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.24 学过的：LC46 · LC78" },
    ...
    { date: "12.2", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.25 学过的：LC39 · LC46" },
    ...
    { date: "12.3", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.26 学过的：LC22 · LC78" },
    ...
    { date: "12.4", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.27 学过的：LC5 · LC72" },
    ...
    { date: "12.6", week: "日", lines: [
      ...
      { c: "lc", label: "🧱 刷题", text: "三数之和 · LC15 + 盛最多水的容器 · LC11" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.29 学过的：LC33 · LC153" },
    ...
    { date: "12.7", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 11.30 学过的：LC4 · LC33" },
    ...
    { date: "12.8", week: "二", lines: [
      ...
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Mobile Payment: Pros and Cons（移动支付的利弊）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "滑动窗口最大值 · LC239 + 找到字符串中所有字母异位词 · LC438" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.1 学过的：LC1 · LC283" },
    ...
    { date: "12.9", week: "三", lines: [
      ...
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「移动支付」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "爬楼梯 · LC70 + 最大子数组和 · LC53" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.2 学过的：LC206 · LC141" },
    ...
    { date: "12.10", week: "四", lines: [
      ...
      { c: "lc", label: "🧱 刷题", text: "最长递增子序列 · LC300 + 最长公共子序列 · LC1143" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.3 学过的：LC20 · LC739" },
    ...
    { date: "12.11", week: "五", lines: [
      ...
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「中国书法」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "零钱兑换 · LC322 + 打家劫舍 · LC198" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.4 学过的：LC102 · LC94" },
    ...
    { date: "12.13", week: "日", lines: [
      { c: "lc", label: "🧱 刷题", text: "全排列 · LC46 + 子集 · LC78" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.6 学过的：LC15 · LC11" },
    ...
    { date: "12.16", week: "三", lines: [
      { c: "lc", label: "🧱 刷题", text: "最长回文子串 · LC5 + 编辑距离 · LC72" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.9 学过的：LC70 · LC53" },
    ...
    { date: "12.17", week: "四", lines: [
      { c: "lc", label: "🧱 刷题", text: "岛屿数量 · LC200 + 腐烂的橘子 · LC994" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.10 学过的：LC300 · LC1143" },
    ...
    { date: "12.18", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.11 学过的：LC322 · LC198" },
    ...
    { date: "12.20", week: "日", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.13 学过的：LC46 · LC78" },
    ...
    { date: "12.21", week: "一", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.14 学过的：LC39 · LC22" },
      { c: "bagu", label: "📡 计网", text: "计网八股收尾" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "12.22", week: "二", lines: [
      { c: "lc", label: "🧱 刷题", text: "课程表 II · LC210 + 课程表 · LC207" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.15 学过的：LC22 · LC46" },
    ...
    { date: "12.23", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.16 学过的：LC5 · LC72" },
    ...
    { date: "12.24", week: "四", lines: [
      { c: "lc", label: "🧱 刷题", text: "前 K 个高频元素 · LC347 + 数组中的第K个最大元素 · LC215" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.17 学过的：LC200 · LC994" },
    ...
    { date: "12.25", week: "五", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.18 学过的：LC733 · LC547" },
    ...
    { date: "12.27", week: "日", lines: [
      { c: "lc", label: "🧱 刷题", text: "搜索旋转排序数组 · LC33 + 寻找旋转排序数组中的最小值 · LC153" },
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.20 学过的：LC547 · LC200" },
    ...
    { date: "12.30", week: "三", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.23 学过的：LC215 · LC347" },
    ...
    { date: "12.31", week: "四", lines: [
      ...
      { c: "lc", label: "🔁 复习旧题", text: "回刷 12.24 学过的：LC347 · LC215" },
...
const VERSIONS = [
  ...
  { v: "v5", date: "2026-09-24", title: "逐日计划加重：刷题 2 新 + 1 旧", desc: "逐日计划 9–12 月刷题从每天 1 道加到「2 新 + 1 旧」（每天补一道同专题伴生题 + 一条按遗忘曲线复习旧题）；TS 主线保留每天语法点，每周日加一条「综合小项目」串起本周内容。" },
];
