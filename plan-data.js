...
const FITNESS = [
  {
    ...
    modules: [
      {
        name: "训练分化（每周）", range: "每周 6 练 1 休", goal: "胸 / 背 / 肩 / 腿 + 护腰",
        items: [
          "周一 · 主胸 + 三头：卧推 / 上斜哑铃 / 双杠 / 夹胸 + 绳索下压",
          "周二 · 背 + 二头：引体 / 胸靠凳划船 / 高位下拉 / 绳索划船 / 面拉 + 弯举",
          "周三 · 肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher",
          "周四 · 休息：不训练，只做腰修复 + 全身拉伸",
          "周五 · 腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心",
          "周六 · 次胸 + 中束 + 斜方：上斜卧推 / 平板哑铃 / 侧平举 / 耸肩",
          "周日 · 轻恢复：快走 20min + 核心 10min + 全身拉伸",
        ],
      },
      {
...
const DAILY_PLAN = {
  "2026-09": [
    ...
    { date: "9.21", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.6 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「教育」核心词 40 个 + 复习错词 ｜ 2021.6 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「中国高铁」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "9.24", week: "四", lines: [
      ...
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "休息：不训练，全身拉伸 + 充分休息" },
    ]},
    ...
    { date: "9.28", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.6 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「健康/运动」核心词 40 个 + 复习错词 ｜ 2024.6 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「春节」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
  ...
  "2026-10": [
    ...
    { date: "10.5", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.12 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「教育」核心词 40 个 + 复习错词 ｜ 2021.12 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「中国功夫」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "10.12", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.12 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「健康/运动」核心词 40 个 + 复习错词 ｜ 2024.12 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「人口老龄化」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "10.19", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.6 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「教育」核心词 40 个 + 复习错词 ｜ 2022.6 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「互联网发展」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "10.26", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.6 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「健康/运动」核心词 40 个 + 复习错词 ｜ 2025.6 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「故宫」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
  ...
  "2026-11": [
    ...
    { date: "11.2", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.12 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「教育」核心词 40 个 + 复习错词 ｜ 2022.12 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「茶文化」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "11.9", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.12 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「健康/运动」核心词 40 个 + 复习错词 ｜ 2025.12 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「中医药」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "11.16", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.6 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「教育」核心词 40 个 + 复习错词 ｜ 2023.6 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「教育公平」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "11.23", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2026.6 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「健康/运动」核心词 40 个 + 复习错词 ｜ 2026.6 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「长城」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "11.30", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.12 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「教育」核心词 40 个 + 复习错词 ｜ 2023.12 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「中华美食」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "两个正序数组的中位数 · LC4" },
  ...
  "2026-12": [
    ...
    { date: "12.7", week: "一", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.6 卷 Section A 长对话×2（逐句听写 · 标连读/生词）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「健康/运动」核心词 40 个 + 复习错词 ｜ 2021.6 卷 仔细阅读 Pass 1（限时 15 分钟 · 先题后文定位）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「中国高铁」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "无重复字符的最长子串 · LC3" },
...
const VERSIONS = [
  { v: "v21", date: "2026-09-21", title: "逐日计划每天贴当日资源链接", desc: "逐日计划每个日期下方新增「🔗 今日资源」一行，按当天任务自动列出当天要用的链接：真题题库（音频/阅读/范文）+ 背单词，点开即用。" },
  { v: "v20", date: "2026-09-21", title: "逐日计划英语任务加可点链接", desc: "逐日计划里「🎧 六级听力 / 📖 词汇阅读 / ✍️ 写作翻译」每条后面加可点开的资源链接（真题听力音频 / 背单词 / 真题范文）；英语专区默认展开，资源链接一眼可见。" },
  { v: "v19", date: "2026-09-21", title: "新增健身专区 + 健身进逐日计划", desc: "新增「💪 健身专区」（训练分化 / 每日腰部修复 / 核心 / 增重营养 / 检验指标）；逐日计划 9.21 起每天加「腰修复 + 当日训练」两条，周六休息并入健身提示。" },
  { v: "v18", date: "2026-09-21", title: "六级加资源链接", desc: "六级英语专区新增「常用资源链接」：BBC 六分钟英语、不背单词、墨墨背单词、四六级历年真题、星火数媒资源库，点开即用。" },
  { v: "v17", date: "2026-09-21", title: "六级精细到逐日 + 逐月", desc: "逐日计划 9.21–12.11 每天拆成「听力 / 词汇·阅读 / 写作·翻译」三条具体任务（含当天作文题目、翻译主题、真题卷号），12.12 标为考试日、12.13 起撤下六级；英语专区六级改成 9 / 10 / 11 / 12 月四阶段计划。" },
