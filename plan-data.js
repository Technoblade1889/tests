...
const DAILY_PLAN = [
  { date: "9.10", week: "四", ds: "二叉树前序遍历 · LC144（C++）", py: "字典：统计一句话每个词出现次数", ts: "" },
  { date: "9.11", week: "五", ds: "二叉树中序遍历 · LC94", py: "字典进阶：写「姓名→分数」查分脚本（增删改查）", ts: "" },
  { date: "9.12", week: "六", ds: "二叉树后序遍历 · LC145", py: "字典收尾 + 集合 set：列表去重 / 交集差集", ts: "" },
  { date: "9.13", week: "日", ds: "层序遍历 · LC102（+ 手写三种遍历再一遍）", py: "函数：写判断素数 / 斐波那契", ts: "装 Node + tsx，跑通第一个 hello.ts" },
  { date: "9.14", week: "一", ds: "前+中序构造二叉树 · LC105", py: "函数进阶：默认参数、返回多个值", ts: "基本类型 + 写一个带类型的小函数" },
  { date: "9.15", week: "二", ds: "中+后序构造二叉树 · LC106", py: "文件读写：读一个 txt 统计词频 top5", ts: "接口 interface：描述一个「学生 / 商品」对象并打印" },
  { date: "9.16", week: "三", ds: "前+后序构造 · LC889（选做）+ 线索二叉树概念", py: "文件读写：把数据写进文件再读回来", ts: "函数类型 + 可选/默认参数：写个计算器函数" },
  { date: "9.17", week: "四", ds: "第10节 哈夫曼树（概念手写，无题）", py: "✅ Python 已够用，停（时间给 TS / 刷题）", ts: "类 class：写一个类并实例化" },
  { date: "9.18", week: "五", ds: "N 叉树层序遍历 · LC429", py: "", ts: "泛型 generics：写 first<T> 和一个泛型函数" },
  { date: "9.19", week: "六", rest: "机动 / 补漏：把本周没做完的题和 TS 小脚本补一补，没状态就休息" },
  { date: "9.20", week: "日", rest: "休息 / 机动：不排新内容" },
  { date: "9.21", week: "一", ds: "二叉树层平均值 · LC637", py: "", ts: "联合类型 + 类型守卫：写类型收窄的例子" },
  { date: "9.22", week: "二", ds: "星型图中心节点 · LC1791", py: "", ts: "async/await：写一个读文件的小脚本" },
  { date: "9.23", week: "三", ds: "小镇法官 · LC997", py: "", ts: "async/await + fetch：调一个公开 JSON 接口打印" },
  { date: "9.24", week: "四", ds: "岛屿数量 · LC200", py: "", ts: "综合小工具：命令行待办清单（增删改查，存内存）" },
  { date: "9.25", week: "五", rest: "机动 / 补漏：补本周内容，或休息" },
  { date: "9.26", week: "六", ds: "图像渲染 · LC733", py: "", ts: "待办清单：加文件持久化（读写 JSON）" },
  { date: "9.27", week: "日", rest: "休息 / 机动：不排新内容" },
  { date: "9.28", week: "一", ds: "省份数量 · LC547", py: "", ts: "待办清单：拆模块 + 整理 README" },
  { date: "9.29", week: "二", ds: "复习：树 + 图 DFS/BFS 手写", py: "", ts: "待办清单：补类型 + 错误处理" },
  { date: "9.30", week: "三", ds: "月底复盘：手写一个完整结构（反转链表 + 二叉树遍历）", py: "", ts: "整理 9 月 TS 产出，写一份「我会什么」清单" },
];
