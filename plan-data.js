...
const ENGLISH = [
  {
    ...
    advice: [
      "你的固定节奏：每天早背 40 个六级单词 + 精听 1 篇真题听力，碎片时间练 1 段翻译、背作文模板好句，晚上听 BBC 六分钟英语练语感——这几项作为每日固定任务坚持到考前；作文每周完整写 1–2 篇并找人 / AI 批改。",
...
const DAILY = {
  schedule: [
    ...
    { time: "午间 / 课间", title: "六级作文 + 翻译", note: "背 1 个作文模板好句 + 练 1 段汉译英，碎片时间完成" },
  ...
  tasks: [
    ...
    { id: "cet-write", label: "六级作文（背模板 / 好句，每周写 1–2 篇）" },
    { id: "cet-trans", label: "六级翻译（每天 1 篇汉译英）" },
