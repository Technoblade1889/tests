    ...
    modules: [
      {
        ...
        items: [
          ...
          "周四 · 肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher",
...
const VERSIONS = [
  { v: "v22", date: "2026-09-21", title: "周一训练顺延 + 周一不额外学英语", desc: "逐日计划里每个周一去掉当天额外的六级英语任务（周一晚有雅思口语课）；周一训练整周顺延一天——周一休息，周二练主胸+三头、周三背+二头、周四肩+核心，周五腿/周六次胸/周日轻恢复不变，仍是每周 6 练 1 休。" },
