...
// 刷题：只用 C++（STL 方言）。题目统一在「数据结构学习地图 DS_MAP」一处，每天 2 新 + 1 旧（约 12 新/周），第一段实习前累计 250+ 题，不刷题海。
...
const ENGLISH = [
  {
    key: "cet6",
    title: "大学英语六级 (CET-6)",
    tag: "12.12 考试 · 大厂简历常设门槛 · 目标 550+ 高分",
    advice: [
      "总时间线：12.12 考试倒推——9.21–10.18 打基础（词汇 + 听力 + 阅读入门）→ 10.19–11.15 强化刷真题 + 专项突破 → 11.16–12.11 冲刺模考 + 复盘。",
      "每天固定节奏：早背 40 个主题核心词 + 精听 1 段真题听力 + 限时做 1 篇真题阅读 + 作文/翻译轮换（每周 2 篇完整作文 + 2 篇完整翻译），晚上 BBC 六分钟练语感。",
      "词汇：核心 5500 词按主题背（教育/科技/环境…），40 词/天 + 错词复习，用「不背单词 / 墨墨」。",
      "听力：真题 Section A 长对话、Section B 听力篇章、Section C 讲座分项精听，每周日整套限时 30 分钟。",
      "阅读：先题后文定位，仔细阅读 30 分钟 2 篇、选词填空先标词性、段落匹配扫关键词。",
      "写作：背 3–5 个万能模板 + 三段式，每天的具体作文题目见「逐日计划」，写完用 AI 批改。",
      "翻译：每天具体主题见「逐日计划」，重点积累中国文化词 + 四字格 + 固定搭配。",
      "真题来源：近 5 年真题（2021.6–2026.6，星火 / 华研 / 新东方六级真题均可），11 月中起每周整套模考，考前刷 3–5 套复盘。",
    ],
    modules: [
      {
        name: "9 月 · 打基础", range: "9.21 – 9.30", goal: "词汇开背 + 听力/阅读入门",
        items: [
          "词汇：核心词开背，40 词/天，主题式（教育/科技/环境…）",
          "听力：真题精听入门，长对话 + 听力篇章逐句听写",
          "阅读：认识三大题型（选词填空/段落匹配/仔细阅读），先题后文",
          "写作：背 3 个万能模板 + 好句，每天列 1 个三段式提纲",
          "翻译：每天 1 段短句汉译英，积累中国文化词",
        ],
      },
      {
        name: "10 月 · 强化", range: "10.1 – 10.31", goal: "分项刷真题 + 开始完整写译",
        items: [
          "词汇：核心词过半，加真题高频词 + 易混词",
          "听力：Section A/B/C 分项精听，每周日整套限时 30 分钟",
          "阅读：限时刷真题（仔细阅读 30 分钟 2 篇 / 选词填空 / 段落匹配）",
          "写作：每周 2 篇完整作文 + AI 批改（具体题目见逐日计划）",
          "翻译：每周 2 篇完整汉译英（中国文化主题）",
        ],
      },
      {
        name: "11 月 · 刷真题", range: "11.1 – 11.30", goal: "真题成套 + 专项突破",
        items: [
          "真题：近 5 年真题成套刷，每周 1 套全真模考",
          "听力：成套限时 30 分钟 + 错题逐句精听",
          "阅读：成套限时 40 分钟 + 错题定位复盘",
          "写作：每周 2 篇 + 限时 30 分钟模拟",
          "翻译：每周 2 篇 + 限时 30 分钟",
        ],
      },
      {
        name: "12 月 · 冲刺", range: "12.1 – 12.11", goal: "模考 + 复盘",
        items: [
          "全真模考：每周 1–2 套整套限时，考前刷 3–5 套",
          "写作：高频主题限时 + 模板套用",
          "翻译：高频主题限时 + 表达复盘",
          "词汇：高频词 + 作文/翻译话题词冲刺",
          "12.12 考试日：轻松上阵",
    ...
    links: [
      { text: "🎧 BBC 6 Minute English（泛听练语感）", url: "https://www.bbc.com/learningenglish/features/6-minute-english" },
      { text: "📱 不背单词（真实语境背词）", url: "https://bbdc.cn/" },
      { text: "📱 墨墨背单词（遗忘曲线复习）", url: "https://www.maimemo.com/" },
      { text: "📄 四六级历年真题（近四年 PDF + 听力音频）", url: "https://zhenti.burningvocabulary.com/" },
      { text: "📚 星火数媒资源库（真题 / 解析 / 听力音频）", url: "https://xinghuoshumei.com.cn/" },
    ],
  },
  {
    key: "ielts",
...
const FITNESS = [
  {
    key: "gym",
    title: "健身 · 增肌塑形（伏黑甚尔式倒三角）",
    tag: "181cm / 67kg 起步 · 目标 80kg+ · 护腰优先",
    advice: [
      "增重第一：每天 3000–3300 kcal、蛋白 140–160g，3 餐 + 2 加餐；连续两周体重没涨就再加 200–300 kcal。",
      "目标节奏：每周体重 +0.25~0.5kg；卧推 50kg → 3 个月 70kg → 12 个月 90–100kg。",
      "护腰：压腰椎的大重量动作一律避让（杠铃深蹲 / 硬拉 / 大重量俯身划船），改用腿举、高脚杯深蹲、胸靠凳划船。",
      "腰劳损提醒：以下是保守方向；若腰疼急性、或疼麻往下窜到腿脚，先看骨科 / 康复科。",
    ],
    modules: [
      {
        name: "训练分化（每周）", range: "每周 5 练 2 休", goal: "胸 / 背 / 肩 / 腿 + 护腰",
        items: [
          "周一 · 休息：不训练，只做腰修复 + 全身拉伸",
          "周二 · 主胸 + 三头：卧推 / 上斜哑铃 / 双杠 / 夹胸 + 绳索下压",
          "周三 · 背 + 二头：引体 / 胸靠凳划船 / 高位下拉 / 绳索划船 / 面拉 + 弯举",
          "周四 · 轻恢复：快走 20min + 核心 10min + 全身拉伸",
          "周五 · 肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher",
          "周六 · 次胸 + 中束 + 斜方：上斜卧推 / 平板哑铃 / 侧平举 / 耸肩",
          "周日 · 腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心",
        ],
      },
      {
        name: "每日腰部修复（掰直）", range: "每天 5–8 分钟", goal: "先掰直→活动→强化→放松",
        items: [
          "麦肯基撑起 2×10（掰直核心，越疼越停）",
          "猫牛式 2×10",
          "臀桥 2×15",
          "死虫式 2×8/侧",
          "鸟狗式 2×8/侧",
      ...
      {
        name: "核心 finisher", range: "每周 4 次", goal: "每次 5–8 分钟",
        items: [
          "平板支撑 3×30–60s（腰不塌）",
          "死虫式 3×10/侧",
          "鸟狗式 3×10/侧",
      ...
      {
        name: "增重营养", range: "每天", goal: "3000+ kcal · 蛋白 140–160g",
        items: [
          "每天 3000–3300 kcal，3 餐 + 2 加餐",
          "蛋白 140–160g：每顿都要有鸡胸 / 鸡蛋 / 奶 / 牛肉 / 鱼",
          "加餐：牛奶 / 花生酱 / 燕麦 / 酸奶 / 鸡蛋",
          "每周晨起空腹称重，看 7 天平均",
        ],
      },
      {
        name: "检验指标 / 里程碑", range: "固定频率", goal: "体重 + 围度 + 力量 + 引体 + 平板 + 照片",
        items: [
          "体重：晨起空腹周均，+0.25~0.5kg/周",
          "围度：胸 / 臂 / 肩 / 腿 / 腰，每月量一次",
          "力量：卧推 / 划船 / 推举 / 腿举记录，每周 +1.25~2.5kg",
          "引体：每月测极限 0→3→8→12→15",
          "平板支撑：每月计时 1→2→3min",
          "照片：正 / 侧 / 背三张，每月同光线",
        ],
      },
...
const DAILY = {
  schedule: [
    ...
    { time: "午间 / 课间", title: "六级作文 + 翻译", note: "背作文模板好句 + 练汉译英，当天具体题目见「逐日计划」" },
    ...
    { time: "晚上（整块）", title: "② 数据结构手写 + C++ 刷题", note: "每天 2 新 + 1 旧（约 12 新/周），用 C++ 刷对应节 2-3 道题" },
  ...
  tasks: [
    ...
    { id: "cet-listen", label: "六级精听 1 篇真题听力" },
    { id: "cet-write", label: "六级作文（每周 2 篇完整 + AI 批改，题目见逐日计划）" },
    { id: "cet-trans", label: "六级翻译（每周 2 篇完整 + 每天积累表达）" },
...
// c（颜色）: lc=刷题橙 · main=主线蓝 · aux=副线/课业绿 · proj=项目/投递紫 · bagu=八股青 · en=六级绿 · fit=健身红
// 每周六固定休息（rest）。
// ============================================================
...
const DAILY_PLAN = {
  "2026-09": [
    { date: "9.13", week: "日", lines: [
      { c: "lc", label: "🧱 刷题", text: "二叉树前序遍历 · LC144（C++） + 二叉树的中序遍历 · LC94" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "aux", label: "🐍 Python", text: "字典：统计一句话每个词出现次数" },
      { c: "main", label: "💙 TS", text: "装 Node + tsx，跑通第一个 hello.ts（顺带看 .js 版本，体会 TS=JS+类型）" },
      { c: "proj", label: "🧩 本周综合小项目", text: "装好 Node+tsx，把本周语法（变量/函数/数组）串成一个「命令行问候」小脚本并跑通" },
    ]},
    { date: "9.14", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "二叉树中序遍历 · LC94 + 二叉树的后序遍历 · LC145" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "9.15", week: "二", lines: [
      { c: "lc", label: "🧱 刷题", text: "二叉树后序遍历 · LC145 + 二叉树的层序遍历 · LC102" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "9.18", week: "五", lines: [
      { c: "lc", label: "🧱 刷题", text: "中+后序构造二叉树 · LC106 + 根据前序和后序遍历构造二叉树 · LC889" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "9.20", week: "日", lines: [
      { c: "lc", label: "🧱 刷题", text: "前+后序构造 · LC889（选做）+ 线索二叉树概念 + 从前序与中序遍历序列构造二叉树 · LC105" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "TS 基本类型注解 + 接口 interface：给「学生 / 商品」对象写类型并打印" },
      { c: "proj", label: "🧩 本周综合小项目", text: "给「学生成绩单」写完整 TS 类型（interface + 函数类型 + 泛型），编译 0 报错" },
    ]},
    ...
    { date: "9.22", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.12 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「科技/AI」核心词 40 个 + 复习错词 ｜ 2021.12 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Should College Students Use AI to Finish Homework?（大学生用 AI 完成作业是否可取）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "N 叉树层序遍历 · LC429 + 二叉树的层平均值 · LC637" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "类 class + 继承 + 类型：写一个类、子类继承并实例化" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "主胸 + 三头：卧推 / 上斜哑铃 / 双杠 / 夹胸 + 绳索下压" },
    ]},
    { date: "9.23", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.6 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「环境/环保」核心词 40 个 + 复习错词 ｜ 2022.6 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「移动支付」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "二叉树层平均值 · LC637 + 二叉树的层序遍历 · LC102" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "泛型 generics：写 first<T> 和一个泛型函数" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "背 + 二头：引体 / 胸靠凳划船 / 高位下拉 / 绳索划船 / 面拉 + 弯举" },
    ]},
    { date: "9.24", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.12 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「社会/民生」核心词 40 个 + 复习错词 ｜ 2022.12 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『The Impact of Short Videos on Young People（短视频对年轻人的影响）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「茶文化」核心表达" },
      { c: "lc", label: "🧱 刷题", text: "星型图中心节点 · LC1791 + 岛屿数量 · LC200" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "9.25", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.6 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「经济/职场」核心词 40 个 + 复习错词 ｜ 2023.6 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「中国书法」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "小镇法官 · LC997 + 图像渲染 · LC733" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "综合小工具①：命令行待办清单（增删改查，存内存）" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "9.26", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "9.27", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「文化/传统」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Importance of Lifelong Learning（终身学习的重要性）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "岛屿数量 · LC200 + 腐烂的橘子 · LC994" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "待办清单②：加文件持久化（读写 JSON）+ 错误处理" },
      { c: "proj", label: "🧩 本周综合小项目", text: "待办清单 CLI：把本周 class/泛型/联合类型/异步串成一个能跑的小工具" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "9.28", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "图像渲染 · LC733 + 岛屿数量 · LC200" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "待办清单③：拆模块 + 补全类型 + 整理 README" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "9.29", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.12 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「网络/传媒」核心词 40 个 + 复习错词 ｜ 2024.12 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Online Education: Pros and Cons（在线教育的利弊）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "省份数量 · LC547 + 腐烂的橘子 · LC994" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "9.30", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.6 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「心理/情感」核心词 40 个 + 复习错词 ｜ 2025.6 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「四大发明」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
  ...
  "2026-10": [
    { date: "10.1", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.12 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「成长/成功」核心词 40 个 + 复习错词 ｜ 2025.12 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『How to Reduce Academic Pressure（如何缓解学业压力）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「中医药」核心表达" },
    ...
    { date: "10.2", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2026.6 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「创新/创业」核心词 40 个 + 复习错词 ｜ 2026.6 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「京剧」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "搜索插入位置 · LC35 + 二分查找 · LC704" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.3", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "10.4", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「国际/热点」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Value of Volunteering（志愿服务的价值）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "网络延迟时间 · LC743（Dijkstra） + K 站中转内最便宜的航班 · LC787" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "模块 import / export：拆成多文件的小项目" },
      { c: "aux", label: "📚 数据结构", text: "第14节 最短路径" },
      { c: "proj", label: "🧩 本周综合小项目", text: "把待办清单拆成多文件模块（import/export 打通，npm 能跑）" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "10.5", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "K 站中转内最便宜的航班 · LC787 + 网络延迟时间 · LC743" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.6", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.6 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「科技/AI」核心词 40 个 + 复习错词 ｜ 2022.6 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Big City or Small Town?（去大城市还是小城市发展）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "课程表 · LC207（拓扑排序） + 课程表 II · LC210" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.7", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.12 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「环境/环保」核心词 40 个 + 复习错词 ｜ 2022.12 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「城市化」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "课程表 II · LC210 + 课程表 · LC207" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.8", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.6 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「社会/民生」核心词 40 个 + 复习错词 ｜ 2023.6 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
    ...
    { date: "10.9", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.12 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「经济/职场」核心词 40 个 + 复习错词 ｜ 2023.12 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「环境保护」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "将有序数组转换为二叉搜索树 · LC108 + 验证二叉搜索树 · LC98" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.10", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "10.11", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「文化/传统」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『How to Live a Low-Carbon Life（如何践行低碳生活）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "两数之和 · LC1 + 字母异位词分组 · LC49" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "命令行工具：fetch 调 JSON 接口（查天气）" },
      { c: "aux", label: "📚 数据结构", text: "第19节 散列表 / 哈希冲突" },
      { c: "proj", label: "🧩 本周综合小项目", text: "天气查询 CLI：async/await + fetch + JSON 解析串成一个小工具" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "10.12", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "有效的字母异位词 · LC242 + 最长连续序列 · LC128" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "命令行工具：解析 JSON + 打印" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "10.13", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.6 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「网络/传媒」核心词 40 个 + 复习错词 ｜ 2025.6 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Value of Traditional Culture（传统文化的价值）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "字母异位词分组 · LC49 + 两数之和 · LC1" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.14", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.12 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「心理/情感」核心词 40 个 + 复习错词 ｜ 2025.12 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「丝绸之路」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "最长连续序列 · LC128 + 有效的字母异位词 · LC242" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.15", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2026.6 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「成长/成功」核心词 40 个 + 复习错词 ｜ 2026.6 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『Never Judge a Book by Its Cover（不以貌取人）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「长城」核心表达" },
      { c: "lc", label: "🧱 刷题", text: "排序数组 · LC912（手写冒泡 / 插入） + 颜色分类 · LC75" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.16", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.6 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「创新/创业」核心词 40 个 + 复习错词 ｜ 2021.6 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「汉字与汉语热」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "移动零 · LC283 + 排序数组 · LC912" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "产出小工具③：待办清单文件持久化" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "10.17", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "10.18", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「国际/热点」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Mobile Payment: Pros and Cons（移动支付的利弊）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "对链表进行插入排序 · LC147 + 排序链表 · LC148" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "💙 TS", text: "产出小工具④：待办清单拆模块 + README" },
      { c: "proj", label: "🧩 本周综合小项目", text: "待办清单加文件持久化 + 补全类型 + README（本周可交付产出）" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "10.19", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "数组中的第 K 个最大元素 · LC215（堆） + 数据流中的第 K 大元素 · LC703" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.20", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.12 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「科技/AI」核心词 40 个 + 复习错词 ｜ 2022.12 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『On the Spirit of Innovation（论创新精神）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "前 K 个高频元素 · LC347 + 数组中的第K个最大元素 · LC215" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.21", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.6 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「环境/环保」核心词 40 个 + 复习错词 ｜ 2023.6 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「乡村振兴」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "数据流中的第 K 大元素 · LC703 + 前 K 个高频元素 · LC347" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.22", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.12 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「社会/民生」核心词 40 个 + 复习错词 ｜ 2023.12 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『How to Bridge the Generation Gap（如何弥合代沟）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「中华美食」核心表达" },
      { c: "lc", label: "🧱 刷题", text: "排序链表 · LC148（归并） + 对链表进行插入排序 · LC147" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.23", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.6 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「经济/职场」核心词 40 个 + 复习错词 ｜ 2024.6 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「中国航天」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "颜色分类 · LC75 + 排序数组 · LC912" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🧩 异步", text: "fetch 调 REST API + JSON 解析" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "10.24", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "10.25", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「文化/传统」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Importance of Perseverance（坚持的重要性）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "搜索旋转排序数组 · LC33 + 寻找旋转排序数组中的最小值 · LC153" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🧩 异步", text: "fetch + 错误处理：超时 / 状态码 / try-catch" },
      { c: "proj", label: "🧩 本周综合小项目", text: "个人主页展示页：HTML/CSS/Flex/响应式 串成一张能上线的页面" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "10.26", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "在排序数组中查找首末位置 · LC34 + 二分查找 · LC704" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🧩 异步", text: "fetch 调自己的接口（本地起一个服务）" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "10.27", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.12 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「网络/传媒」核心词 40 个 + 复习错词 ｜ 2025.12 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Internet Security and Personal Privacy（网络安全与个人隐私）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "两个正序数组的中位数 · LC4 + 在排序数组中查找元素的第一个和最后一个位置 · LC34" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "10.28", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2026.6 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「心理/情感」核心词 40 个 + 复习错词 ｜ 2026.6 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「孔子与儒家思想」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "10.29", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.6 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「成长/成功」核心词 40 个 + 复习错词 ｜ 2021.6 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『What Does Success Mean to You?（成功的意义）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「中国高铁」核心表达" },
    ...
    { date: "10.30", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.12 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「创新/创业」核心词 40 个 + 复习错词 ｜ 2021.12 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「移动支付」5 句 + 背固定搭配" },
    ...
    { date: "10.31", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ],
  ...
  "2026-11": [
    { date: "11.1", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「国际/热点」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『How to Deal with Failure（如何面对失败）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "两数之和 · LC1 + 有效的字母异位词 · LC242" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🟩 Node", text: "Node 运行模型 / 事件循环" },
      { c: "proj", label: "🧩 本周综合小项目", text: "用 Node 把待办清单改成本地 HTTP 服务（GET/POST 增删改查）" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    ...
    { date: "11.3", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.6 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「科技/AI」核心词 40 个 + 复习错词 ｜ 2023.6 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Role of Social Media in Our Lives（社交媒体的作用）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
    ...
    { date: "11.4", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.12 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「环境/环保」核心词 40 个 + 复习错词 ｜ 2023.12 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「中国书法」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "11.5", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.6 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「社会/民生」核心词 40 个 + 复习错词 ｜ 2024.6 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『Reading Books vs. Watching Videos（读书与看视频）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「春节」核心表达" },
    ...
    { date: "11.6", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.12 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「经济/职场」核心词 40 个 + 复习错词 ｜ 2024.12 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「四大发明」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "每日温度 · LC739 + 接雨水 · LC42" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🟩 Node", text: "Node 基础收尾：跑通一个服务端脚本" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "11.7", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "11.8", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「文化/传统」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Should We Pursue Fame and Wealth?（名与利是否值得追求）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "二叉树的层序遍历 · LC102 + 中序遍历 · LC94" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🟩 Express", text: "Express 中间件 / 路由" },
      { c: "proj", label: "🧩 本周综合小项目", text: "Express 版 todo CRUD，写完用 fetch 自测一遍接口" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    ...
    { date: "11.10", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2026.6 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「网络/传媒」核心词 40 个 + 复习错词 ｜ 2026.6 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Importance of Time Management（时间管理的重要性）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "无重复字符的最长子串 · LC3 + 三数之和 · LC15" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "11.11", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.6 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「心理/情感」核心词 40 个 + 复习错词 ｜ 2021.6 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「京剧」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "最小覆盖子串 · LC76 + 滑动窗口最大值 · LC239" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "11.12", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.12 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「成长/成功」核心词 40 个 + 复习错词 ｜ 2021.12 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『Should College Students Use AI to Finish Homework?（大学生用 AI 完成作业是否可取）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「中国功夫」核心表达" },
      { c: "lc", label: "🧱 刷题", text: "找到字符串中所有字母异位词 · LC438 + 最小覆盖子串 · LC76" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "11.13", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.6 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「创新/创业」核心词 40 个 + 复习错词 ｜ 2022.6 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「城市化」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "滑动窗口最大值 · LC239 + 找到字符串中所有字母异位词 · LC438" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🟩 Express", text: "fetch 调通自己的接口" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "11.14", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "11.15", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「国际/热点」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Impact of Short Videos on Young People（短视频对年轻人的影响）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "三数之和 · LC15 + 盛最多水的容器 · LC11" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🚀 部署", text: "部署：Vercel" },
      { c: "proj", label: "🧩 本周综合小项目", text: "把 Node/Express 本周内容串成一个完整 todo 服务（路由 + 中间件 + REST + 错误处理），准备部署" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "11.16", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "接雨水 · LC42 + 盛最多水的容器 · LC11" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🚀 部署", text: "部署：Cloudflare Workers" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "11.17", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.12 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「科技/AI」核心词 40 个 + 复习错词 ｜ 2023.12 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Importance of Lifelong Learning（终身学习的重要性）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
    ...
    { date: "11.18", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.6 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「环境/环保」核心词 40 个 + 复习错词 ｜ 2024.6 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「环境保护」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "最长递增子序列 · LC300 + 最长公共子序列 · LC1143" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "11.19", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.12 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「社会/民生」核心词 40 个 + 复习错词 ｜ 2024.12 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『Online Education: Pros and Cons（在线教育的利弊）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「人口老龄化」核心表达" },
      { c: "lc", label: "🧱 刷题", text: "零钱兑换 · LC322 + 打家劫舍 · LC198" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "11.20", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.6 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「经济/职场」核心词 40 个 + 复习错词 ｜ 2025.6 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「丝绸之路」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "最长公共子序列 · LC1143 + 编辑距离 · LC72" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "proj", label: "🛠 项目①", text: "调 Gemini 做摘要" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "11.21", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "11.22", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「文化/传统」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『How to Reduce Academic Pressure（如何缓解学业压力）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "打家劫舍 · LC198 + 最大子数组和 · LC53" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "proj", label: "🛠 项目①", text: "发布到 GitHub Pages" },
      { c: "proj", label: "🧩 本周综合小项目", text: "把本周 Express 内容串成一份「接口文档」README（项目①之外的巩固）" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "11.23", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "不同路径 · LC62 + 打家劫舍 · LC198" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "proj", label: "🛠 项目①", text: "写 README 进简历" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "11.24", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.6 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「网络/传媒」核心词 40 个 + 复习错词 ｜ 2021.6 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Value of Volunteering（志愿服务的价值）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
    ...
    { date: "11.25", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.12 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「心理/情感」核心词 40 个 + 复习错词 ｜ 2021.12 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「汉字与汉语热」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "组合总和 · LC39 + 全排列 · LC46" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "11.26", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.6 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「成长/成功」核心词 40 个 + 复习错词 ｜ 2022.6 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『Big City or Small Town?（去大城市还是小城市发展）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「互联网发展」核心表达" },
      { c: "lc", label: "🧱 刷题", text: "括号生成 · LC22 + 子集 · LC78" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "11.27", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.12 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「创新/创业」核心词 40 个 + 复习错词 ｜ 2022.12 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「乡村振兴」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "最长回文子串 · LC5 + 编辑距离 · LC72" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "proj", label: "🛠 项目①", text: "复盘：这个项目学到什么" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "11.28", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "11.29", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「国际/热点」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『The Importance of Physical Exercise（体育锻炼的重要性）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "搜索旋转排序数组 · LC33 + 旋转数组最小值 · LC153" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🟩 Node", text: "11 月复盘：后端 / 部署 / 项目① 查漏" },
      { c: "proj", label: "🧩 本周综合小项目", text: "11 月成果盘点：写「后端能力清单」（会什么 / 缺什么）" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "11.30", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "两个正序数组的中位数 · LC4 + 搜索旋转排序数组 · LC33" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
  ...
  "2026-12": [
    { date: "12.1", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.6 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「科技/AI」核心词 40 个 + 复习错词 ｜ 2024.6 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『How to Live a Low-Carbon Life（如何践行低碳生活）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
    ...
    { date: "12.2", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2024.12 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「环境/环保」核心词 40 个 + 复习错词 ｜ 2024.12 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「中国航天」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
    ...
    { date: "12.3", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.6 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「社会/民生」核心词 40 个 + 复习错词 ｜ 2025.6 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『The Value of Traditional Culture（传统文化的价值）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「故宫」核心表达" },
    ...
    { date: "12.4", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2025.12 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「经济/职场」核心词 40 个 + 复习错词 ｜ 2025.12 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「孔子与儒家思想」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "二叉树的层序遍历 · LC102 + 二叉树的中序遍历 · LC94" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🟩 后端", text: "部署：Vercel / Cloudflare Workers" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "12.5", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "12.6", week: "日", lines: [
      { c: "en", label: "🎧 六级听力", text: "整套听力（25 题 · 限时 30 分钟 · 对答案精听错题）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「文化/传统」核心词 40 个 + 复习错词 ｜ 整套阅读（选词填空 + 段落匹配 + 仔细阅读×2 · 限时 40 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Never Judge a Book by Its Cover（不以貌取人）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "三数之和 · LC15 + 盛最多水的容器 · LC11" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🟩 后端", text: "后端进阶收尾：鉴权 + 部署跑通" },
      { c: "proj", label: "🧩 本周综合小项目", text: "JWT 鉴权 mini 接口：登录 → 发 token → 访问受保护接口" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "12.7", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "无重复字符的最长子串 · LC3 + 最小覆盖子串 · LC76" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "12.8", week: "二", lines: [
      { c: "en", label: "🎧 六级听力", text: "2021.12 卷 Section B 听力篇章×2（逐句听写）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「网络/传媒」核心词 40 个 + 复习错词 ｜ 2021.12 卷 仔细阅读 Pass 2（限时 15 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文：『Mobile Payment: Pros and Cons（移动支付的利弊）』三段式（限时 30 分钟 · 写完用 AI 批改）" },
      { c: "lc", label: "🧱 刷题", text: "滑动窗口最大值 · LC239 + 找到字符串中所有字母异位词 · LC438" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "12.9", week: "三", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.6 卷 Section C 讲座×1（精听 · 记主旨+细节）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「心理/情感」核心词 40 个 + 复习错词 ｜ 2022.6 卷 选词填空（限时 10 分钟 · 先标词性）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：汉译英「移动支付」段落（约 150 字 · 限时 30 分钟 · 积累文化词/四字格）" },
      { c: "lc", label: "🧱 刷题", text: "爬楼梯 · LC70 + 最大子数组和 · LC53" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "12.10", week: "四", lines: [
      { c: "en", label: "🎧 六级听力", text: "2022.12 卷 Section C 讲座×2（精听）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「成长/成功」核心词 40 个 + 复习错词 ｜ 2022.12 卷 段落匹配（限时 12 分钟 · 扫关键词）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "作文提纲：『On the Spirit of Innovation（论创新精神）』列三段式大纲 + 好句 3 句 ｜ 翻译积累：「茶文化」核心表达" },
      { c: "lc", label: "🧱 刷题", text: "最长递增子序列 · LC300 + 最长公共子序列 · LC1143" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "12.11", week: "五", lines: [
      { c: "en", label: "🎧 六级听力", text: "2023.6 卷 Section A 长对话 + 听力篇章×1（半套）" },
      { c: "en", label: "📖 六级词汇·阅读", text: "背「创新/创业」核心词 40 个 + 复习错词 ｜ 2023.6 卷 仔细阅读 Pass 1 + 选词填空（限时 25 分钟）" },
      { c: "en", label: "✍️ 六级写作·翻译", text: "翻译：短句汉译英「中国书法」5 句 + 背固定搭配" },
      { c: "lc", label: "🧱 刷题", text: "零钱兑换 · LC322 + 打家劫舍 · LC198" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "12.12", week: "六", rest: "🏆 六级考试日：上午考（作文 30min + 听力 30min + 阅读 40min + 翻译 30min），带齐准考证 / 身份证 / 调频耳机" },
    { date: "12.13", week: "日", lines: [
      { c: "lc", label: "🧱 刷题", text: "全排列 · LC46 + 子集 · LC78" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "bagu", label: "📡 计网", text: "OSI / TCP-IP 分层模型" },
      { c: "proj", label: "🧩 本周综合小项目", text: "把 12 月上旬的 JWT 后端小项目收尾：补错误处理 + 环境变量，代码进 GitHub" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "12.14", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "组合总和 · LC39 + 括号生成 · LC22" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "bagu", label: "📡 计网", text: "TCP 三次握手 / 四次挥手" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "12.15", week: "二", lines: [
      { c: "lc", label: "🧱 刷题", text: "括号生成 · LC22 + 全排列 · LC46" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "12.18", week: "五", lines: [
      { c: "lc", label: "🧱 刷题", text: "图像渲染 · LC733 + 省份数量 · LC547" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "bagu", label: "📡 计网", text: "计网八股过一遍：高频题自测" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "12.19", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "12.20", week: "日", lines: [
      { c: "lc", label: "🧱 刷题", text: "省份数量 · LC547 + 岛屿数量 · LC200" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "bagu", label: "📡 计网", text: "计网收口：错题 + 重点复盘" },
      { c: "proj", label: "🧩 本周综合小项目", text: "用 TS 手写 LRU 缓存（双向链表 + 哈希），为寒假问数系统打底" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    ...
    { date: "12.23", week: "三", lines: [
      { c: "lc", label: "🧱 刷题", text: "数组中的第 K 个最大元素 · LC215 + 前 K 个高频元素 · LC347" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
    ...
    { date: "12.25", week: "五", lines: [
      { c: "lc", label: "🧱 刷题", text: "合并 K 个升序链表 · LC23 + 两数相加 · LC2" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🤖 LLM", text: "结构化输出：要求返回 JSON" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "肩 + 核心：坐姿推举 / 侧平举 / 后束面拉 / 耸肩 + 核心 finisher" },
    ]},
    { date: "12.26", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    { date: "12.27", week: "日", lines: [
      { c: "lc", label: "🧱 刷题", text: "搜索旋转排序数组 · LC33 + 寻找旋转排序数组中的最小值 · LC153" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🤖 LLM", text: "问数前置：调 LLM 把自然语言生成 SQL" },
      { c: "proj", label: "🧩 本周综合小项目", text: "串起「LLM→SQL」最小闭环，留作寒假原型起点" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
      { c: "fit", label: "💪 训练", text: "腿(护腰版) + 核心：腿举 / 高脚杯深蹲 / 腿屈伸 / 腿弯举 / 臀桥 + 核心 finisher" },
    ]},
    { date: "12.28", week: "一", lines: [
      { c: "lc", label: "🧱 刷题", text: "在排序数组中查找首末位置 · LC34 + 寻找两个正序数组的中位数 · LC4" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
      { c: "main", label: "🤖 LLM", text: "LLM API：错误处理 + 限流重试" },
      { c: "fit", label: "💪 腰修复", text: "每日腰修复：麦肯基撑起→猫牛→臀桥→死虫→鸟狗→婴儿式→悬垂（5–8 分钟）" },
    ]},
    { date: "12.29", week: "二", lines: [
      { c: "lc", label: "🧱 刷题", text: "LRU 缓存 · LC146 + 最小栈 · LC155" },
      { c: "lc", label: "🔁 复习旧题", text: "重刷 1 道旧题（本周错题优先 · 按遗忘曲线 1/2/4/7/15 天）" },
  ...
  "2027-01": [
    ...
    { date: "1.2", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "1.9", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "1.16", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "1.23", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "1.30", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ...
  "2027-02": [
    ...
    { date: "2.6", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "2.13", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "2.20", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "2.27", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ...
  "2027-03": [
    ...
    { date: "3.6", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "3.13", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "3.20", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "3.27", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ...
  "2027-04": [
    ...
    { date: "4.3", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "4.10", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "4.17", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "4.24", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ...
  "2027-05": [
    { date: "5.1", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "5.8", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "5.15", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "5.22", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "5.29", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ...
  "2027-06": [
    ...
    { date: "6.5", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "6.12", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "6.19", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "6.26", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ...
  "2027-07": [
    ...
    { date: "7.3", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "7.10", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "7.17", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "7.24", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "7.31", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
  ],
  ...
  "2027-08": [
    ...
    { date: "8.7", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "8.14", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "8.21", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
    ...
    { date: "8.28", week: "六", rest: "周六休息：不排 CS 学习；健身照常——次胸 + 中束 + 斜方 + 每日腰修复" },
...
const VERSIONS = [
  { v: "v0", date: "2026-08-29", title: "网站初版", desc: "AI 向学习计划 + 每日安排（时间表 / 任务清单）+ 英语专区上线。" },
  { v: "v1", date: "2026-09-06", title: "主线改版 + 苹果风视觉", desc: "主线改为 Agent 工程化 + 后端（TS 为主）；新增项目完成时间表；整体苹果风视觉。" },
  { v: "v2", date: "2026-09-15", title: "逐日计划全年 12 个月", desc: "逐日具体计划从只有 9 月扩展到全年 12 个月，每天带具体刷题题目；点上方月份即可切换对应月份的逐日计划；TS 起步前前置 JS 速成。" },
  { v: "v3", date: "2026-09-20", title: "逐日计划加入六级", desc: "逐日具体计划 9.21–12 月底每天加一条「🌍 六级」（背 40 词 + 精听 + 作文/翻译，随阶段推进到冲刺模考），周六休息日跳过。" },
  { v: "v4", date: "2026-09-21", title: "新增健身专区 + 健身进逐日计划", desc: "新增「💪 健身专区」（训练分化 / 每日腰部修复 / 核心 / 增重营养 / 检验指标）；逐日计划 9.21 起每天加「腰修复 + 当日训练」两条，周六休息并入健身提示。" },
];
